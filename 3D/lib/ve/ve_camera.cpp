...
namespace ve {
	void VeCamera::setOrthographicProjection(float left, float right, float bottom, float top, float near, float far) {
	...
	void VeCamera::setPerspectiveProjection(float fovy, float aspectRatio, float near, float far) {
	...
	void VeCamera::setViewDirection(glm::vec3 position, glm::vec3 direction, glm::vec3 up) {
		// Construct a Orthonormal Basis (ONB) from a look direction and an up vector
